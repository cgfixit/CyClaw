...
| **DNS-rebinding → state-changing POST** | `TrustedHostMiddleware` Host allow-list (outside CORS and the routes; only the security-headers middleware wraps it) | `gate.py`, `config.yaml` |
