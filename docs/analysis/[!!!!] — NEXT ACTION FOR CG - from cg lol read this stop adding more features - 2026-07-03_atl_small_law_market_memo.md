> note: is the 3rd time ive found out a *claw name i chose already existed and this whole  report was generated on the premise of the wrong  lol... anyways kind of amazing while connected to this cc to the repo it confused the name with the one rhat web searches return more.
