...
- `docs/work/SETUP.md` (moved from `docs/SETUP.md`) — moved; the file is a short stub pointing at `/setup-guide.md` at the repo root (Windows · macOS · Linux, Ollama). A second pointer lives at `docs/! How-To-Guides/setup-guide.md`. Root is canonical; neither pointer is a second full copy.
