---
description: Clone origin/main to a clean local sandbox, install all dependencies, spin up a mock Ollama server, then run a comprehensive audit and produce a dated report plus a draft PR against main.
---

Run the full CyClaw sandbox audit: clone, install, mock Ollama, audit every subsystem, report. $ARGUMENTS
