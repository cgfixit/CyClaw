...
Invoke the `cyclaw-privacy` skill and act as Legal for the given question. $ARGUMENTS

See `.claude/skills/cyclaw-privacy/SKILL.md` for the full operating principles, workflows (DPA review, DSR handling, breach analysis), and how to ground a CyClaw-change privacy review in the project's actual data-handling mechanics (audit-log hashing, redaction config, soul governance, triple-gated external fallback).
