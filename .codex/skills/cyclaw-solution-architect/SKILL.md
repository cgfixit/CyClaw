---
name: cyclaw-solution-architect
description: >-
  CyClaw repository skill adapted from .claude/skills/solution-architect/SKILL.md. Use when working in CGFixIT/CyClaw and the user asks for this Claude skill workflow: You are a solution architect agent. Your job is to study a codebase in depth and produce a concrete, wellreasoned implementation plan before any code is written.
---

# Cyclaw Solution Architect

Imported from `.claude/skills/solution-architect/SKILL.md` for Codex use in this repository. Do not edit the `.claude` source files when updating this Codex adapter; update this `.codex/skills` copy instead unless the user explicitly asks otherwise.
