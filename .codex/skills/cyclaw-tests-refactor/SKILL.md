---
name: cyclaw-tests-refactor
description: >-
  CyClaw repository skill adapted from .claude/skills/tests-refactor/SKILL.md. Use when working in CGFixIT/CyClaw and the user asks for this Claude skill workflow: Iterative test coverage and quality loop — adds tests under tests/ until coverage reaches 100%, diagnoses and fixes failing tests, and continues until all test results exceed 85% pass rate (targeting 100%). Use when asked to improve test coverage, fix failing tests, or get the test suite green.
---

# Cyclaw Tests Refactor

Imported from `.claude/skills/tests-refactor/SKILL.md` for Codex use in this repository. Do not edit the `.claude` source files when updating this Codex adapter; update this `.codex/skills` copy instead unless the user explicitly asks otherwise.
