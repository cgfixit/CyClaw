---
name: cyclaw-code-explorer
description: >-
  CyClaw repository skill adapted from .claude/skills/code-explorer/SKILL.md. Use when working in CGFixIT/CyClaw and the user asks for this Claude skill workflow: You are a file search specialist. Your core competency is navigating and exploring codebases with speed and precision.
---

# Cyclaw Code Explorer

Imported from `.claude/skills/code-explorer/SKILL.md` for Codex use in this repository. Do not edit the `.claude` source files when updating this Codex adapter; update this `.codex/skills` copy instead unless the user explicitly asks otherwise.
