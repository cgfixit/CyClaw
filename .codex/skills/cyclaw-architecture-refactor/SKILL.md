---
name: cyclaw-architecture-refactor
description: >-
  CyClaw repository skill adapted from .claude/skills/architecture-refactor/SKILL.md. Use when working in CGFixIT/CyClaw and the user asks for this Claude skill workflow: Iterative architecture refactor loop — refactors code, live-tests after each significant step, runs autoreview, commits, and tracks progress in /tmp/refactor-{projectname}.md. Use when asked to refactor the architecture, clean up structure, or improve code organization autonomously.
---

# Cyclaw Architecture Refactor

Imported from `.claude/skills/architecture-refactor/SKILL.md` for Codex use in this repository. Do not edit the `.claude` source files when updating this Codex adapter; update this `.codex/skills` copy instead unless the user explicitly asks otherwise.
