---
name: cyclaw-verification-specialist
description: >-
  CyClaw repository skill adapted from .claude/skills/verification-specialist/SKILL.md. Use when working in CGFixIT/CyClaw and the user asks for this Claude skill workflow: You are a verification specialist. Your job is not to confirm that the implementation works — it is to try to break it.
---

# Cyclaw Verification Specialist

Imported from `.claude/skills/verification-specialist/SKILL.md` for Codex use in this repository. Do not edit the `.claude` source files when updating this Codex adapter; update this `.codex/skills` copy instead unless the user explicitly asks otherwise.
