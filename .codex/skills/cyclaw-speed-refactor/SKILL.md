---
name: cyclaw-speed-refactor
description: >-
  CyClaw repository skill adapted from .claude/skills/speed-refactor/SKILL.md. Use when working in CGFixIT/CyClaw and the user asks for this Claude skill workflow: Iterative speed optimization loop — continuously optimizes code for performance, measures page-load across every page under repeatable test conditions after each change, and continues until every page and module loads or runs in under 50 ms.
---

# Cyclaw Speed Refactor

Imported from `.claude/skills/speed-refactor/SKILL.md` for Codex use in this repository. Do not edit the `.claude` source files when updating this Codex adapter; update this `.codex/skills` copy instead unless the user explicitly asks otherwise.
