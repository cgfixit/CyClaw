...
name: cyclaw-wrap-up
description: >-
  CyClaw repository skill adapted from .claude/skills/wrap-up/SKILL.md. Use when working in CGFixIT/CyClaw and the user asks for this Claude skill workflow: Use when user says "wrap up", "close session", "end session" or "done
---

# Cyclaw Wrap Up

Imported from `.claude/skills/wrap-up/SKILL.md` for Codex use in this repository. Do not edit the `.claude` source files when updating this Codex adapter; update this `.codex/skills` copy instead unless the user explicitly asks otherwise.
