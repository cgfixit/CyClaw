...
``real-repo-run-decide`` subcommands, and from there to the terminal's
authenticated ``POST /ops/agentic`` route (via ``utils.ops_runner``'s
CLI-subprocess shim -- never a direct import, per I6).
