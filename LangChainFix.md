...
- A phase 0-5 scaffold already exists at `agentic/deepagent_github/`
  ...
  design than the repo layout proposed below. See
  ...
  current state of that scaffold. The layout proposed below would overwrite
  already-shipped files; reconcile against that plan document before
  implementing anything from this document.
